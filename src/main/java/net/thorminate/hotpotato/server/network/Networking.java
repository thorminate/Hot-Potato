...
public class Networking {
    public static void register() {
        PayloadTypeRegistry.playS2C().register(CountdownPayload.ID, CountdownPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(RequestCountdownPayload.ID, RequestCountdownPayload.CODEC);

        ServerPlayNetworking.registerGlobalReceiver(
                RequestCountdownPayload.ID,
